...
.. image:: https://travis-ci.org/kstrauser/pytest-fastest.svg?branch=master
    :target: https://travis-ci.org/kstrauser/pytest-fastest
    :alt: See Build Status on Travis CI

.. image:: https://ci.appveyor.com/api/projects/status/github/kstrauser/pytest-fastest?branch=master
    :target: https://ci.appveyor.com/project/kstrauser/pytest-fastest/branch/master
