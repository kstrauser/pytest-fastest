# -*- coding: utf-8 -*-
#
# pytest-fastest documentation build configuration file, created by
...
project = u'pytest-fastest'
copyright = u'2018, Kirk Strauser'
author = u'Kirk Strauser'

with open('../VERSION') as infile:
    _version = infile.read().strip()
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', u'pytest-fastest Documentation',
     [author], 1)
]
